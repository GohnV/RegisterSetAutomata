...
if len(sys.argv) != 2:
    print("Usage: python bench_rxxr2.py (python|grep|pcre2)", file=sys.stderr)
    sys.exit(1)
set_enemy(sys.argv[1])
if get_enemy() not in ENEMIES:
    print("Invalid argument, Usage: python bench_rxxr2.py (python|grep|pcre2)", file=sys.stderr)
